...
#import "ASEmptyVIew.h"

@implementation ASEmptyVIew
...
-(void)awakeFromNib
{
    ...
    [self.retrybutton setTintColor:AS_APP_MainColor];
    [self.retrybutton.layer setBorderColor:AS_APP_MainColor.CGColor];
   //[self.TitleLabel setText:@"Hmm..you'are not connected to the internet\n\nPlease try again"];
    NSMutableParagraphStyle *paragraphstyle=[[NSMutableParagraphStyle alloc] init];
    [paragraphstyle setLineSpacing:5.0];
    
    NSAttributedString *titleAttString=[[NSAttributedString alloc] initWithString:@"Hmm..you'are not connected to the internet\nPlease try again" attributes:@{NSParagraphStyleAttributeName:paragraphstyle,NSFontAttributeName:[UIFont systemFontOfSize:15.0],NSForegroundColorAttributeName:ASUISColorS(130, 1.0)}];
